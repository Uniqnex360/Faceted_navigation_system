          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <div className="bg-white p-6 rounded-lg border border-slate-200">
                ...
                <h3 className="font-semibold text-slate-900 mb-1">Facets Recommended</h3>
              ...
              <div className="bg-white p-6 rounded-lg border border-slate-200">
                ...
                <h3 className="font-semibold text-slate-900 mb-1">Yet to Start</h3>
              ...
              <div className="bg-white p-6 rounded-lg border border-slate-200">
                ...
                <h3 className="font-semibold text-slate-900 mb-1">Downloaded Outputs</h3>
              ...
              <div className="bg-white p-6 rounded-lg border border-slate-200">
                ...
                <h3 className="font-semibold text-slate-900 mb-1">Total Projects</h3>
...
{user?.role === 'client_admin' && (
  <span className="inline-block mt-2 px-2 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded">
    Client Admin
        ...
        <div className="absolute bottom-0 left-0 right-0 w-64 p-4 border-t border-slate-200">
          <button
            onClick={signOut}
