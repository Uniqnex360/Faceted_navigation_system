...
export default function PromptManagement() {
  ...
  return (
    <div className="relative min-h-screen">
      <div className="sticky top-0 z-30 bg-slate-50 border-b border-slate-200 shadow-sm mb-6">
        <div className="max-w-full mx-auto px-2 py-4">
          ...
          <div className="mt-4 flex flex-col h-[calc(100vh-280px)]">
            {isEditing && selectedPrompt ? (
                  ...
                  {selectedPrompt.name === "Industry Analysis" && (
                    <div>
                      ...
                      <div className="space-y-6">
                        {Object.entries(industryLevels).map(
                          ([level, content]) => (
                            <div
                              key={level}
                            ...
                            >
                              <div className="flex justify-between items-center mb-3">
                                ...
                                <button
                                  onClick={() =>
                                    removeIndustryLevel(Number(level))
                                  }
              ...
              <>
              <div className="bg-white rounded-lg border border-slate-200 overflow-hidden flex flex-col flex-1">
            ...
            <p className="text-sm text-slate-600">
              ...
              latest version for facet generation. Mark prompts with Level 2-10
              as master templates for comprehensive facet building.
            </p>
          </div>
          </>
            )}
